...
<div class="w-screen h-screen flex items-center justify-center bg-indigo-50/40 min-w-[350px]">
  <div class="w-full grid grid-rows-3 justify-center container mx-auto px-4 sm:px-6 lg:px-36">
    ...
    <div class="flex flex-wrap justify-center mt-6 gap-x-8 gap-y-4 col-auto">
      ...
      <div class="flex justify-center w-auto">
        <button
          on:click={postIndex}
          class="block text-sm bg-indigo-500 px-4 py-2 rounded-full text-indigo-50 font-chubbo font-semibold"
        >
          Start Indexing
        </button>
      </div>
